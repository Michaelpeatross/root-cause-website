...
def generate_template_report_html(
    ...
    blood_reconciliation_html=None, previous_scores=None,
):
    """Build HTML report styled like the Full Scan PDF template.

    previous_scores: optional dict of prior Health Scores for progress display,
    e.g. {'overall': 72, 'digestive': 61, 'nervous': 80, ...}
    """
    ...
    body_overview_html = render_body_overview_html(
        body_overview, previous_scores=previous_scores,
    )
